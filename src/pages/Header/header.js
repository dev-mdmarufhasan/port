...
<p>Github</p>
                ...
                <a className="linkedin" href="https://www.linkedin.com/in/edewor-Maruf Ahmed Raj/" target="_blank">
...
<p>Twitter</p>
                ...
                <a className="schedule" href="https://calendly.com/edeworMaruf Ahmed Raj" target="_blank">
...
<p>Calendly</p>
                ...
                <div className="small_menu">
                    <ul>
                        ...
                        <li className="menu-three"><a className="nav-link" href="https://hackernoon.com/u/Maruf Ahmed Raj" target="_blank">Writing</a></li>
                        ...
                        <li className="menu-five"><a className="nav-link" href="mailto:edeworMaruf Ahmed Raj@gmail.com" target="_blank">Contact</a></li>
                    </ul>
                    </div>    
            </div>
            </div>
